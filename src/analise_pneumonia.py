...
reference_population_by_age_group_sex = datasets_service.get_reference_population_by_sex_and_year(reference_population_raw,pneumoCom_dataset_raw)
reference_population_by_age_group_region = datasets_service.get_reference_population_by_age_group_region_and_year(reference_population_raw,pneumoCom_dataset_raw)
