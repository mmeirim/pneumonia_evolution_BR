...
def generate_overview_table(base,begin_year,last_year):
    ...
    lst_dfs = [admissoes_total,admissoes_S,admissoes_N,admissoes_NE,admissoes_SE,admissoes_CO,mortes_total,mortes_S,mortes_N,mortes_NE,mortes_SE,
                ...
                admissoes_eld,admissoes_non_eld,admissoes_uti_eld,admissoes_uti_non_eld,admissoes_non_uti_eld,admissoes_non_uti_non_eld,mortes_eld,
                mortes_non_eld]
    ...
    lst_nomes = ['Admissions','Admissions_S','Admissions_N','Admissions_NE','Admissions_SE','Admissions_CO','Deaths','Deaths_S','Deaths_N',
                    ...
                    'Admissions_non_uti_NE','Admissions_non_uti_SE','Admissions_non_uti_CO','Admissions_eld','Admissions_non_eld',
                    'Admissions_uti_eld','Admissions_uti_non_eld','Admissions_non_uti_eld','Admissions_non_uti_non_eld','Deaths_eld','Deaths_non_eld']
...
def generate_100k_rates_table(base,dfWHO,pop_ref,pop_ref_by_sex,pop_ref_by_region,begin_year,last_year):
    ...
    lst_dfs = [admissoes_total_tx_adjusted,admissoes_S_tx_adjusted,admissoes_N_tx_adjusted,admissoes_NE_tx_adjusted,admissoes_SE_tx_adjusted,
                ...
                admissoes_non_uti_NE_tx_adjusted,admissoes_non_uti_SE_tx_adjusted,admissoes_non_uti_CO_tx_adjusted,admissoes_eld_tx_adjusted,
                admissoes_non_eld_tx_adjusted,admissoes_uti_eld_tx_adjusted,admissoes_uti_non_eld_tx_adjusted,admissoes_non_uti_eld_tx_adjusted,
                admissoes_non_uti_non_eld_tx_adjusted,mortes_eld_tx_adjusted,mortes_non_eld_tx_adjusted]
    lst_nomes = ['Admissions_Tx','Admissions_S_Tx','Admissions_N_Tx','Admissions_NE_Tx','Admissions_SE_Tx','Admissions_CO_Tx','Mortality_Tx',
                    ...
                    'Admissions_non_uti_SE_Tx','Admissions_non_uti_CO_Tx','Admissions_eld_Tx','Admissions_non_eld_Tx',
                    'Admissions_uti_eld_Tx','Admissions_uti_non_eld_Tx','Admissions_non_uti_eld_Tx','Admissions_non_uti_non_eld_Tx','Mortality_eld_Tx',
...
def generate_lethality_table(base,dfWHO,begin_year,last_year):
    ...
    lst_dfs = [letalidade_total_tx_adjusted,letalidade_S_tx_adjusted,letalidade_N_tx_adjusted,letalidade_NE_tx_adjusted,letalidade_SE_tx_adjusted,
                ...
                letalidade_non_uti_SE_tx_adjusted,letalidade_non_uti_CO_tx_adjusted,letalidade_eld_tx_adjusted,
                letalidade_non_eld_tx_adjusted,letalidade_uti_eld_tx_adjusted,letalidade_uti_non_eld_tx_adjusted,letalidade_non_uti_eld_tx_adjusted,
    ...
    lst_nomes = ['Lethality_tx','Lethality_S_Tx','Lethality_N_Tx','Lethality_NE_Tx','Lethality_SE_Tx','Lethality_CO_Tx','Lethality_uti_tx',
                ...
                'Lethality_eld_tx','Lethality_non_eld_tx','Lethality_uti_eld_tx','Lethality_uti_non_eld_tx','Lethality_non_uti_eld_tx',
